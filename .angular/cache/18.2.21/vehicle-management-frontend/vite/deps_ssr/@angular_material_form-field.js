...
import {
  ...
  transition,
  trigger
} from "./chunk-WWIZ5AKH.js";
import {
  CommonModule,
  DOCUMENT,
  NgTemplateOutlet,
  isPlatformBrowser
} from "./chunk-CA4D7CGS.js";
import {
...
var MatFormFieldFloatingLabel = class _MatFormFieldFloatingLabel {
  ...
  constructor(_elementRef) {
    ...
    this._resizeSubscription = new import_rxjs7.Subscription();
  }
  ngOnDestroy() {
    this._resizeSubscription.unsubscribe();
  }
...
var MatFormField = class _MatFormField {
  ...
  _initializeControl(previousControl) {
    ...
    if (control.ngControl && control.ngControl.valueChanges) {
      this._valueChanges = control.ngControl.valueChanges.pipe((0, import_operators6.takeUntil)(this._destroyed)).subscribe(() => this._changeDetectorRef.markForCheck());
    }
  }
  ...
  _initializePrefixAndSuffix() {
    ...
    (0, import_rxjs7.merge)(this._prefixChildren.changes, this._suffixChildren.changes).subscribe(() => {
      this._checkPrefixAndSuffixTypes();
      this._changeDetectorRef.markForCheck();
    });
  }
  ...
  _initializeOutlineLabelOffsetSubscriptions() {
    ...
    this._dir.change.pipe((0, import_operators6.takeUntil)(this._destroyed)).subscribe(() => this._needsOutlineLabelOffsetUpdate = true);
  }
