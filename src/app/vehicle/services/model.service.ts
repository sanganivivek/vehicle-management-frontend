...
// Updated/Placeholder interface for the new stats structure
...
export class VehicleService {
  ...
  // UPDATED: Calls /api/dashboard/stats
  getDashboardData(): Observable<DashboardStatsResponse> {
    return this.http
      .get<DashboardStatsResponse>(`${environment.apiUrl}/dashboard/stats`)
      .pipe(catchError(this.handleError));
  }
  ...
  updateVehicle(id: string, vehicle: any): Observable<any> {
    ...
    const updatePayload = {
      ...
      currentStatus: vehicle.currentStatus, // Confirmed: This is being sent
    };
    return this.http
